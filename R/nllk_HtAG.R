#' Negative logarithm likelihood of the Heteroscedastic Age and Growth Model (HtAG) 
#'
...
#' 
#' @param pars Vector of the parameters to be estimated (q, Linf, K, A), where A is a age composition vector.
#' 
#' @return Return a negative logarithm likelihood of the Heteroscedastic Age and Growth Model.
#' 
